...
contract OraclePositiveRebaseAsyncExitMainnetForkPoC is TestSetup, Deployed {
    ...
    function test_deployedMintLimitStillAllowsOver73EthExtraction() public {
        ...
        assertEq(mintCapacity, 30_000 ether, "unexpected deployed mint capacity");
        uint256 capital = mintCapacity - 1 gwei;
        ...
        public
    {
        ...
        assertEq(mintConsumableWei, 30_000 ether, "unexpected deployed mint capacity");

        uint256 capital = mintConsumableWei - 1 gwei;
        vm.deal(attacker, capital);
